...
# data ={
#     "Name":"Uday kumar",
#     "Email_id":"udaydevaragudi@gmail.com",
...
#      'courseOffered':'Machine Learing with Deployment'},
#
#     {
#      'companyName':'iNeuron',
#      'product':'Affordable AI',
...
#d=collection.find({"qty":{'$gte':95}})
#d=collection.find({'qty':{'$lt':100},'item':'sketch pad'})
#d=collection.find({'$or':[{'item':'sketch pad'},{'qty':{'$gte':95}}]})
#d=collection.update_one({'item':'canvas'},{'$set':{'item':'kishor'}})
#d=collection.delete_one({'item':'kishor'})
#d=collection.find({'item':'kishor'})
#for i in d:
#    print(i)